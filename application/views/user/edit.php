...
<section class="content">
    <div class="row justify-content-center">
        <div class="col-md-8 col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url('user/edit/') .$useredit['user_id'] ?>" method="post">
                        <div class="form-group">
                            <label for="name">Nama</label>
                            <input type="text" class="form-control" name="user_id" value="<?= $useredit['user_id'] ?>" hidden>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="username" value="<?= $useredit['username'] ?>">
