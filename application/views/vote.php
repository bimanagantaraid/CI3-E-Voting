...
<body>
    ...
    <main class="main">
        <div class="container d-flex justify-content-center">
            <div class="calonpasangan row">
                <?php
                if ($votingstatus['is_active'] == FALSE) {
                    echo "<h1>Voting Ditutup</h1>";
                } else {
                ?>
                            ...
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <a href="#" class="btn btn-info" paslon_id="<?= $p['paslon_id'] ?>">Visi Misi</a>
                                        <?php

                                        if ($pemilihstatus) {

                                        ?>
                                            <button class="btn btn-danger m-1" disabled>Anda sudah memilih</button>
                                            <br>
                                            ...
                                            ?>
                                                <button class="btn btn-vote btn-danger" paslon_id="<?= $p['paslon_id'] ?>" pemilih_id="<?= $pemilih['pemilih_id'] ?>">Vote</button>
                                            <?php
                                            } else {
                                            ?>
                                                <a class="btn btn-warning text-center" href="<?= base_url('auth/loginpemilih') ?>">Vote</a>
                                                <br>
